...
var payment_url = {
    'prod': 'https://merchant.lucsonpay.com/crm/jsp/paymentrequest',
...
module.exports = {
    headers: {
        'authorization': 'YOUR-AUTHORIZATION-HEADER' // will be provided by lucsonpay
    },

    credentails: {
        'pay_id': 'YOUR-MERCHANT-KEY', // will be provided by lucsonpay
        'salt': 'YOUR-SALT-KEY', // will be provided by lucsonpay
    },
    ...
    getPaymentUrl: function() {
        if (this.mode == 'prod') {
            return 'https://merchant.lucsonpay.com/crm/jsp/paymentrequest';
        } else {
            return 'https://uat.lucsonpay.com/crm/jsp/paymentrequest';
        }
    },
